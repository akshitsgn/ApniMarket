...
import 'package:flutterbasics/LoginScreen.dart';

class CreateAccountOtpScreen extends StatefulWidget {
  @override
  _CreateAccountOtpScreen createState() => _CreateAccountOtpScreen();
}

class _CreateAccountOtpScreen extends State<CreateAccountOtpScreen>{
  @override
                        ...
                        child: Align(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: const EdgeInsets.symmetric(horizontal: 126.0, vertical: 12.0),
                            ),
                          ),
                        ),
                      )// here,
